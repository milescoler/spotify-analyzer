...
export function buildSeed(now = Date.now()) {
  ...
  const klass = { id: classId, name: 'Room 3B — 3rd Grade', teacherId: teacher.id };
  ...
  const studentDefs = [
    { name: 'Maya',   diligence: 0.92 },
    { name: 'Liam',   diligence: 0.70 },
    { name: 'Aisha',  diligence: 0.55 },
    { name: 'Noah',   diligence: 0.30 }, // neglected garden — wilting/dead plants
    { name: 'Sofia',  diligence: 0.80 },
  ];
